...
- The internet and literature provides a large and often free source of open information and knowledge on any finance related topci and theory as well as know how concercing any the required quantitavie method (e.g. statistic) .
- Software in order to access and process financial data as well as to program and test an assumed trading algorithm is available for free - basically every piece of software that is needed is available in the form of open source; specifically, Python has become the language and ecosystem of choice
